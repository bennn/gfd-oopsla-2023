...
where $X$ charts a successful path but $Y$ does not is higher that
the proportion of scenarios where $Y$ charts a successful path but
$X$ does not. Of course, the answer may not be clear cut as $X$ and $Y$
...
\item Compute and compare the successes and failures of the strategies.
