...
%      \node (0) [above of=1a,yshift=-2mm] {Program: \bmname{fsm}};
      ...
      \node (2) [above of=1,yshift=2mm,xshift=3cm,draw=black!80] {\cmod{auto}};
...
%      \node (24) [above of = 22,yshift=-6mm] {Deep types};
      ...
      \node (3) [below of=2,yshift=-12mm,draw=black!80] {\cmod{auto}};
...
%      \node (34) [above of = 33,yshift=-6mm] {Shallow types};
      ...
      \draw[-{Stealth[length=2mm,width=2mm]}] (1b.north) -- (2a.south west);
