...
unclear is whether the time the column labeled \code{Total} is a better guide than
the percentages listed in the column labeled \code{Self} or vice versa.  High
