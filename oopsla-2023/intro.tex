...
\item how well feedback helps developers navigate the migration lattice from a
 bad configuration to one with acceptable performance.
...
abstractions, dubbed rational programmers, that reify a falsifiable
...
a large quantity of performance-debugging situations and thus enables an
apples-to-apples comparison of different rational programmers. 
