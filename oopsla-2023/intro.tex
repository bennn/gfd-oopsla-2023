...
problem~(\cref{sec:related}), in particular JIT technology for
...
\begin{quote} \em
 How to navigate the migration lattice of a code base from a
...
\item At the object level, the results of the rational programmer
  experiment provide guidance to developers about how to best use feedback
    ...
    migrating the piece of code with the most costly boundary to use deep types
    significantly outperforms all other  strategies on the scenarios of
