...
\begin{figure}[ht]
  ...
  \newcommand{\kkrow}[1]{\includegraphics[width=0.39\columnwidth]{data/sky/#1-feasible.pdf}}
    \begin{tabular}[t]{ll}
     ...
     \kkrow{acquire} \\
    \end{tabular}
  \caption{An example of a large program with a large black-hole region} \label{fig:bh2}
\end{figure}  

As for method-internal threats, the most important one is that the GTP programs
...
high-overhead programs, they will have to use the general lessons with some
caution. The problem is that such programs may come with large black holes in
...
remains an open question how often such black holes occur in the wild.
