...
\begin{figure}[ht]
  ...
  \newcommand{\kkrow}[1]{\includegraphics[width=0.39\columnwidth]{data/sky/#1-feasible.pdf}}
    ...
    \end{tabular}
  \Description{Results for navigations in migration lattices with zero hopeful scenarios}
...
for the cost-aware optimistic strategy which is one of the most successful
strategies.
