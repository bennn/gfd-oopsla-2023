...
of machine noise~\cite{mdhs:wrong-data,cb-asplos-2013}; for example,
...
However, the 3x ``antennas'' include these borderline configurations and
nevertheless support our overall
conclusions~(\ifappendix{\cref{s:bm-sky}}{supplementary material}).
...
times are quite stable~(\cref{sec:data}).
